class Topic < ActiveRecord::Base
    ...
    def last_answered_at
        @last_answered_at ||= (if last_answer then last_answer.created_at else created_at end)
    end
    ...
    def participants
        @participants ||= answers.map(&:character).uniq.compact
    end
    ...
    def special_character
      @special_character ||= character || links_character || rps_character
    end
